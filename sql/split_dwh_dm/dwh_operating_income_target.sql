...
SELECT period, '工事営業部', '佐々木（大成・鹿島他）', company_sasaki FROM profit_plan WHERE item = '営業利益'
UNION ALL
SELECT period, '工事営業部', '浅井（清水他）', company_asai FROM profit_plan WHERE item = '営業利益'
UNION ALL
SELECT period, '工事営業部', '小笠原（三井住友他）', company_ogasawara FROM profit_plan WHERE item = '営業利益'
UNION ALL
SELECT period, '工事営業部', '高石（内装・リニューアル）', company_takaishi FROM profit_plan WHERE item = '営業利益'
UNION ALL
SELECT period, '工事営業部', '山本（改装）', company_yamamoto FROM profit_plan WHERE item = '営業利益'
...
UNION ALL
SELECT period, '硝子建材営業部', 'ビルサッシ', building_sash FROM profit_plan WHERE item = '営業利益'
UNION ALL
...
UNION ALL
SELECT period, '硝子建材営業部', 'サッシ完成品', sash_finished_products FROM profit_plan WHERE item = '営業利益'
UNION ALL
SELECT period, '硝子建材営業部', 'その他', others FROM profit_plan WHERE item = '営業利益';
