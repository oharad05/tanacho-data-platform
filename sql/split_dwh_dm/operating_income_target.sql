...
fukuoka_target AS (
  ...
  UNION ALL
  SELECT period, '福岡支店', '硝子樹脂部', 'GSセンター', gs_center * 1000 FROM fukuoka_profit_plan WHERE item = '営業利益'
  UNION ALL
  SELECT period, '福岡支店', '硝子樹脂部', '福北センター', fukuhoku_center * 1000 FROM fukuoka_profit_plan WHERE item = '営業利益'
)
